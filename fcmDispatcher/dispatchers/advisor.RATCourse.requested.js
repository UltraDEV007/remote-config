...
exports.dispatch = async ({ payload }, { ctxData, utils, helpers }) => {
  ...
  return {
    ...
    data: {
      type: 'advisor.RATCourse.requested',
      sound: 'sound1',
    },
    apns: {
      payload: {
...
exports.effect = async (
    ...
    blocks: [
      {
        ...
        text: {
          type: 'plain_text',
          text: 'advisor.RATCourse.requested',
        },
      },
      {
        type: 'context',
  ...
  sendgridClient.getClient().sendEmail(advisor_id, {
    template: {
      name: i18n.getTemplateSuffixName('advisor.RATCourse.requested'),
    },
    ...i18n.getContactEmailInfo('advisor.RATCourse.requested'),
    ...ctxData,
    course: {
