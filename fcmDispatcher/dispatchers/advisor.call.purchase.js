...
exports.getVars = ({ payload }, { helpers: { _ } }) => {
  return {
    ...
    service_id: _.get(payload, 'services.data.0.service_id'),
  };
};
...
exports.effect = async (
  ...
  const title = `${userDisplayName} đã mua cuộc gọi(${kind}) của ${advisorDisplayName}`;
